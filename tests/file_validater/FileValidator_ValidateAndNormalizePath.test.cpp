...
TEST(FileValidatorTest, ValidateAndNormalizePath_BasicCases) {
...
TEST(FileValidatorTest, ValidateAndNormalizePath_WithDotDotSegments) {
...
TEST(FileValidatorTest, ValidateAndNormalizePath_WithUnsafeChars) {
...
TEST(FileValidatorTest, ValidateAndNormalizePath_NotUnderDocumentRoot) {
...
TEST(FileValidatorTest, ValidateAndNormalizePath_Normalization) {
