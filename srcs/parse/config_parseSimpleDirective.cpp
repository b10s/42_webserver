...
void ConfigParser::parseRoot(Location* location) {
    parseSimpleDirective(this, location, &Location::setRoot, "root directory path");
}
...
void ConfigParser::parseUploadPath(Location* location) {
    parseSimpleDirective(this, location, &Location::setUploadPath, "upload_path value");
}

void ConfigParser::parseRedirect(Location* location) {
    parseSimpleDirective(this, location, &Location::setRedirect, "redirect value");
}

void ConfigParser::parseServerName(ServerConfig* serverConfig) {
    parseSimpleDirective(this, serverConfig, &ServerConfig::setServerName, "server_name value");
}
